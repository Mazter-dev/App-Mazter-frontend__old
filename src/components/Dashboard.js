            ...
            <div className="content container-fluid">
                            ...
                            <div className="card-body">
                                <div className="dash-widget-header">
                                    ...
                                    <div className="dash-widget-info">
                                        <h3>429</h3>
                                        <h6 className="text-muted">Productos registrados</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="dash-widget-header">
                                    ...
                                    <div className="dash-widget-info">
                                        <h3>148</h3>
                                        <h6 className="text-muted">Ventas de hoy</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="dash-widget-header">
                                    ...
                                    <div className="dash-widget-info">
                                        <h3>124</h3>
                                        <h6 className="text-muted">Total ventas hoy</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="dash-widget-header">
                                    ...
                                    <div className="dash-widget-info">
                                        <h3>$11378</h3>
                                        <h6 className="text-muted">Producto más vendido</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 d-flex">
                        ...
                        <div className="card card-table flex-fill">
                            <div className="card-header">
                                <h4 className="card-title">Productos con pocas unidades</h4>
                            </div>
                            <div className="card-body">
                                <div className="table-responsive">
                                    <table className="table table-center">
